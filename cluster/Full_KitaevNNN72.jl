...
L = 72
Kc = 0.672
params = parameter_line([0,1,0,0], [1//4,1//4,1//4, 1//4], 25)

push!(params, [(1-Kc)/3, Kc, (1-Kc)/3, (1-Kc)/3])
...
QMOC.mpi_sample_full(circuits, n_trajectories, thermalization_time, n_samples, sample_distance, "FullKitaevNNN$(L)")
